                ...
                <table class="table bootstrap-datatable countries">
                  <thead>
                    <tr>
                      ...
                      <th style="background-color: #57b846;color: white;">USER_ID</th>
                      <th style="background-color: #57b846;color: white;">LEAVE_TYPE</th>
                      <th style="background-color: #57b846;color: white;">DATE</th>
                      <th style="background-color: #57b846;color: white;">REASON</th>
                      <th style="background-color: #57b846;color: white;">REQUESTED_DAYS</th>
                      <th style="background-color: #57b846;color: white;">TOTAL_DAYS</th>
                      <th style="background-color: #57b846;color: white;">REMAINING_DAYS</th>
